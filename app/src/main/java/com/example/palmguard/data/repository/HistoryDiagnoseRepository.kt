package com.example.palmguard.data.repository

import com.example.palmguard.data.local.entity.HistoryDiagnose
import com.example.palmguard.data.local.room.HistoryDiagnoseDao
